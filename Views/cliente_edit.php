...
<form id="cadCliente" name="cadCliente" method="post" action="<?php echo BASE_URL;?>Cliente/edit_action/<?php echo $id_cli;?>">
            ...
            <div class="container">
                ...
                <div class="form-row p-4 col-md-11" style="background: #ccc; border-radius: 2%;">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <div class="imgEdit img-thumbnail" alt="Imagem responsiva" style="max-width: 150px"> 
                    ...
                    <div class="form-group col-md-6" style="float:">
                ...
                <div class="form-row p-4 mt-3 col-md-11 flex-direction-column" style="background: #ccc; border-radius: 2%;">
                    <div class="form-group col-md-6">    
                        ...
                        <input id="tempoResidencia" name="tempoResidencia" type="number" class="form-control" value="<?php echo $listar['tempo_residencia'];?>" style="width: 100px;">
                    </div>
                    ...
                    <label for="bairro">Bairro</label>
                        ...
                        <input id="numero" name="numero" type="number" class="form-control" value="<?php echo $listar['numero'];?>" style="width: 100px;">
                        <br>
    ...
    <button class="btn btn-info mt-2 mb-4" type="submit" name="enviar">Alterar</button>
